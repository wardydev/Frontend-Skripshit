                  ...
                  <div className="col-xxl-5 col-lg-5 col-12 nftmax-pcolumn__one pb-4">
                    ...
                    <div className="nftmax__item-form--group">
                      ...
                      <input
                        ...
                        type="text"
                        placeholder="Hukum / Akutansi / Sastra Vietnam / etc."
                        required="required"
                      />
                    </div>
                    <div className="nftmax__item-form--group">
                      <label htmlFor="target" className="nftmax__item-label">
                        Objek Penelitian / Target
                      </label>
                      <input
                        id="target"
                        className="nftmax__item-input"
                        type="text"
                        placeholder="SDN 1 New York / UMKM Las Vegas / etc."
                        required="required"
                      />
                    </div>
                    ...
                    <div className="nftmax__item-form--group">
                      <label
                        htmlFor="minatKeterampilan"
                        className="nftmax__item-label"
                      >
                        Minat / Keterampilan <i>(Optional)</i>
                      </label>
                      <textarea
                        id="minatKeterampilan"
                        className="nftmax__item-input nftmax__item-textarea"
                        placeholder="Deskripsikan minat dan keterampilan Kamu untuk mendapatkan ide judul yang sesuai. (Ex: Saya suka menggambar/ Saya tertarik dengan komunikasi/ Saya suka nyaleg / etc.)"
                        required="required"
                      ></textarea>
                    </div>
                    <div>
